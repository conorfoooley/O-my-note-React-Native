        ...
        >
          ...
          <View style={{ flex: 2.5 }}>
            ...
            <TouchableOpacity onPress={() => this.onButtonPress(0)} style={this.getStyle(0, selected)}>
              ...
              <Icon style={styles.Icon} size={20} name="home" color={this.getIconColor(0, selected)} />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => this.onButtonPress(6)} style={this.getStyle(1, selected)}>
              ...
              <Icon style={styles.Icon} size={20} name="favorite" color={this.getIconColor(1, selected)} />
            </TouchableOpacity>
            {/* @ts-ignore */}
            ...
            <TouchableOpacity onPress={this.shareAppLinks} style={this.getStyle(5, selected)}>
              ...
              <Icon style={styles.Icon} size={20} name="share" color={this.getIconColor(5, selected)} />
            </TouchableOpacity>
            {/* @ts-ignore */}
